...
if __name__ == "__main__":
    try:
        hanoi_secure_graph = SecureGraph(max_nodes=5)
        ...
        shortest_path, distance = hanoi_secure_graph.find_shortest_path("Hoan Kiem", "Cau Giay")
        print(f"Shortest path: {shortest_path}, Distance: {distance}")

        # Testing DoS protection and invalid input
        hanoi_secure_graph.add_location("Invalid@123")  # Should raise error
